...
• Visualizations Utilized:
    o Core Charts: Column, Bar, Line, and Area charts for comparisons and trends.

    o	Map Charts: For displaying geospatial data.

    o	Cards: To highlight key performance indicators.

    o	Tables: For presenting detailed, tabular information.

    o   Chart Variety: Selecting from common and uncommon chart types for   effective storytelling.

• Interactive Features:
    o	Slicers: Enabling dynamic, user-driven data filtering.
